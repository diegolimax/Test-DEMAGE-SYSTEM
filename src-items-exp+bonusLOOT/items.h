...
struct Abilities
{
	...
	int32_t skills[SKILL_LAST + 1], skillsPercent[SKILL_LAST + 1], statsPercent[STAT_LAST + 1],
...
class ItemType
{
	...
	public:
		...
		bool loaded, stopTime, showCount, stackable, showDuration, showCharges, showAttributes, dualWield,
			...
			isAnimation, specialDoor, closingDoor, cache, usetimeBetweenActions, usetimeBetweenExActions;
		...
		uint32_t shootRange, charges, decayTime, attackSpeed, wieldInfo, minReqLevel, minReqReset, minReqMagicLevel,
