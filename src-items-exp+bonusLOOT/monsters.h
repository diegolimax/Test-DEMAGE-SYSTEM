...
struct spellBlock_t
{
	...
	int64_t minCombatValue, maxCombatValue;
...
class MonsterType
{
	public:
		...
		int32_t defense, armor, healthMin, baseSpeed, lookCorpse, corpseUnique, corpseAction,
		...
		uint64_t experience, healthMax, health;
