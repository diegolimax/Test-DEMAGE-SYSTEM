...
class Item : virtual public Thing, public ItemAttributes
{
	public:
		...
		void setOwnerName(std::string name) { setAttribute("ownername", name); }
		...
		int32_t getSellValue() const {return count * items[id].sellValue;}
		...
		bool usetimeBetweenActions() const {return items[id].usetimeBetweenActions;}
		bool usetimeBetweenExActions() const {return items[id].usetimeBetweenExActions;}
		...
		////////////////////////////////////////////////////
		int32_t getDamagePercent() const;
		int32_t getHealingPercent() const;
		int32_t getReflectChance(CombatType_t combat) const;
		int32_t getReflectPercent(CombatType_t combat) const;
...
inline std::string Item::getOwnerName() const
{
	bool ok;
	std::string v = getStringAttribute("ownername", ok);
	if (ok)
		return v;
...
inline uint32_t Item::getPeriod() const
{
	bool ok;
	int32_t v = getIntegerAttribute("period", ok);
	if (ok)
		return (uint32_t)v;
...
inline int32_t Item::getDamagePercent() const
{
	bool ok;
	int32_t v = getIntegerAttribute("damagepercent", ok);
	if(ok)
		return v;

	const ItemType& it = items[id];
	return it.hasAbilities() ? it.abilities->damagePercent : 0;
}

inline int32_t Item::getHealingPercent() const
{
	bool ok;
	int32_t v = getIntegerAttribute("healingpercent", ok);
	if(ok)
		return v;

	const ItemType& it = items[id];
	return it.hasAbilities() ? it.abilities->healingPercent : 0;
}

inline int32_t Item::getReflectChance(CombatType_t combat) const
{
	std::string attribute;
	switch (combat) {
		case COMBAT_PHYSICALDAMAGE: {
			attribute = "reflectchancephysical";
			break;
		}

		case COMBAT_ENERGYDAMAGE: {
			attribute = "reflectchanceenergy";
			break;
		}

		case COMBAT_EARTHDAMAGE: {
			attribute = "reflectchanceearth";
			break;
		}

		case COMBAT_FIREDAMAGE: {
			attribute = "reflectchancefire";
			break;
		}

		case COMBAT_LIFEDRAIN: {
			attribute = "reflectchancelifedrain";
			break;
		}

		case COMBAT_MANADRAIN: {
			attribute = "reflectchancemanadrain";
			break;
		}

		case COMBAT_DROWNDAMAGE: {
			attribute = "reflectchancedrown";
			break;
		}

		case COMBAT_ICEDAMAGE: {
			attribute = "reflectchanceice";
			break;
		}

		case COMBAT_HOLYDAMAGE: {
			attribute = "reflectchanceholy";
			break;
		}

		case COMBAT_DEATHDAMAGE: {
			attribute = "reflectchancedeath";
			break;
		}
	...
	bool ok;
	int32_t v = getIntegerAttribute(attribute, ok);
	if (ok) {
		return v;
	}

	const ItemType& it = items[id];
	return it.abilities ? it.abilities->reflect[REFLECT_CHANCE][combat] : 0;
}

inline int32_t Item::getReflectPercent(CombatType_t combat) const
{
	std::string attribute;
	switch (combat) {
		case COMBAT_PHYSICALDAMAGE: {
			attribute = "reflectpercentphysical";
			break;
		}

		case COMBAT_ENERGYDAMAGE: {
			attribute = "reflectpercentenergy";
			break;
		}

		case COMBAT_EARTHDAMAGE: {
			attribute = "reflectpercentearth";
			break;
		}

		case COMBAT_FIREDAMAGE: {
			attribute = "reflectpercentfire";
			break;
		}

		case COMBAT_LIFEDRAIN: {
			attribute = "reflectpercentlifedrain";
			break;
		}

		case COMBAT_MANADRAIN: {
			attribute = "reflectpercentmanadrain";
			break;
		}

		case COMBAT_DROWNDAMAGE: {
			attribute = "reflectpercentdrown";
			break;
		}

		case COMBAT_ICEDAMAGE: {
			attribute = "reflectpercentice";
			break;
		}

		case COMBAT_HOLYDAMAGE: {
			attribute = "reflectpercentholy";
			break;
		}

		case COMBAT_DEATHDAMAGE: {
			attribute = "reflectpercentdeath";
			break;
		}
	...
	const ItemType& it = items[id];
	return it.abilities ? it.abilities->reflect[REFLECT_PERCENT][combat] : 0;
}
